...
function attach(opts = {}) {
     ...
     */
    const isStarted = () => (service.amqp && service.amqp instanceof AMQPTransport);
    /**
    ...
    if (config.router && config.router.enabled === true) {
        verifyAttachPossibility_1.default(service.router, __1.ActionTransport.amqp);
        service.AMQPRouter = adapter_1.default(service.router, config);
