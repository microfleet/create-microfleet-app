...
const Errors = require('common-errors'); // generate internal error class for passing between amqp
...
function serializeError(error) {
  ...
  serialized.data = Object.getOwnPropertyNames(error).map(serializeOwnProperties, error);
  return serialized;
}
/**
